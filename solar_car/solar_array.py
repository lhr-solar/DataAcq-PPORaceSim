...
class SolarArray:
    def _init_(self):
        ...
        EFFICIENCY_C60 = 0.225  # percentage
        EFFICIENCY_E60 = 0.237  # percentage
        ANNUAL_RADIATION = 1500
        STANDARD_PERFORMANCE_RATIO = 0.75
        self.solarcell_c60 = SolarCell(
            AREA_C60, EFFICIENCY_C60, ANNUAL_RADIATION, STANDARD_PERFORMANCE_RATIO)
        self.solarcell_e60 = SolarCell(
            AREA_E60, EFFICIENCY_E60, ANNUAL_RADIATION, STANDARD_PERFORMANCE_RATIO)
    ...
    def step(self, irradiance: float):
        ...
        return -1
        # we can test some variables other than temperature for the performance ratio